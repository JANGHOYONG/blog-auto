...
- extra_sections: 이 주제에서만 다룰 수 있는 고유한 각도 2~3개를 자유롭게 선택해 작성하세요.
  ...
  대신 이 주제의 의학적 원리·최신 연구·반직관적 사실·연령별 차이·구체 데이터 등 50~60대 독자가 정말 읽고 싶은 심층 정보를 골라 각 섹션 body를 500자 이상의 서술문으로 작성하세요.
  예시 각도: "60대에서 이 치료가 효과가 다른 생물학적 이유", "약 없이 수치를 낮춘 사람들의 공통점", "한국인 데이터가 서양 연구와 다른 이유", "증상이 없어도 위험한 진짜 이유"
...

{
  ...
  "extra_sections": [
    ...
    {
      "h2": "두 번째 고유 각도 — 반직관적 사실이나 연령별 비교 데이터 등",
      "body": "500자 이상의 서술문"
    }
  ],
